...
The **Ripening** phase in [Canola](/docs/Plants/Canola) represents the developmental period from **Maturity** to **HarvestRipe**. It is influenced by thermal time only.
