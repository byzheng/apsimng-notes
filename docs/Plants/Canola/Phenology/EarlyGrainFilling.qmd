...
The **EarlyGrainFilling** phase in [Canola](/docs/Plants/Canola) represents the developmental period from **StartGrainFilling** to **EndFlowering**. It is influenced by thermal time only.
