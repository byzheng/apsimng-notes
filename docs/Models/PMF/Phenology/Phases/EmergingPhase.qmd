...
| `PlantSowing`  | Set the phase target as [GenericPhase](/docs/Models/PMF/Phenology/Phases/GenericPhase.qmd). It also indicates the phase target cannot be dynamically modified. |
