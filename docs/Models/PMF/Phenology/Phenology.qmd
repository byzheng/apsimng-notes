...
- **Sowing Event**: Triggers initialization of phenological stages in the event of [PlantSowing](/docs/Models/Events.qmd#PlantSowing).
...
This is the core event that updates the phenological development at daily timestamp. The phenology development is only proceeded when plant is alive from [Plant](/docs/Models/PMF/Plant.qmd) model.
...
| Method                         | Description                                                             |
|--------------------------------|-------------------------------------------------------------------------|
| [`SetToStage(newStage)`](#settostage)        | Moves the crop to a specific development stage (e.g. flowering).         |


### `SetToStage(newStage)` {#settostage}
