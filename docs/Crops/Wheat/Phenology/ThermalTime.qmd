...
We demonstrate the concept using an [example simulation](/docs/Crops/Wheat/Examples/wheat_example1.qmd) for wheat.

The output variable `Wheat.Phenology.ThermalTime` is used to report the daily thermal time values. 
