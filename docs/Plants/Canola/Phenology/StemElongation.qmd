...
The **StemElongation** phase in [Canola](/docs/Plants/Canola) represents the developmental period from **GreenBud** to **StartFlowering**. It is influenced by thermal time only and the target is influenced by photoperiod.
