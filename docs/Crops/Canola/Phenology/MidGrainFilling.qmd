...
The **MidGrainFilling** phase in [Canola](/docs/Crops/Canola) represents the developmental period from **EndFlowering** to **EndPodDevelopment**. It is influenced by thermal time only.
