...
| Phenology | [Phenology](/docs/Models/PMF/Phenology/Phenology.qmd) | First Available | Supplies current growth stage and timing of key events. |
| ThermalTime | [IFunction](/docs/APSIM.Core/IFunction.qmd) | Child | Calculates accumulated temperature used for leaf and stem development. |
