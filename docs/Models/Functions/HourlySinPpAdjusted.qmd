...
* [IInterpolationMethod](/docs/Models/Core/IInterpolationMethod.qmd)
...
|-----------|-------|-----------------|------------------------------------------------------|
| MetData | [IWeather](/docs/Models/Core/IWeather.qmd) | Link | Provides daily minimum and maximum temperatures, and calculates day length, sunrise, and sunset times. |
