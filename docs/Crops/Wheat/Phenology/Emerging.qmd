...
The [EmergingPhase](/docs/Models/PMF/Phenology/Phases/EmergingPhase.qmd) model simulates the time between the [Germination](/docs/Models/Events/PlantGermination.qmd) and [Emergence](/docs/Models/Events/PlantEmergence.qmd) stages.
