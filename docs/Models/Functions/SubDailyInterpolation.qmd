...
| Response | [IIndexedFunction](/docs/Models/PMF/Interfaces/IIndexedFunction.qmd) | Child, ByName | Applies a transformation to each sub-daily interpolated value. Typically an XYPairs function defining temperature response curves with base, optimum, and maximum thresholds. |
| MetData | [IWeather](/docs/Models/Interfaces/IWeather.qmd) | First Available | Provides daily weather data including minimum and maximum values for the variable being interpolated (usually air temperature). |
