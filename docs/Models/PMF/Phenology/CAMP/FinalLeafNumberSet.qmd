...
fln_data <- data.frame(
    Parameter_FLN = c("MinLN", "PpLN", "VrnLN", "VxPLN", "LV", "SV", "SN", "LN"),
    BattenWinter = c(8.16, 3.61, 3.10, 6.99, 8.16, 11.77, 14.87, 18.25),
    BattenSpring = c(8.25, 7.55, 0.19, -0.03, 8.25, 15.80, 15.99, 8.41)
)
...
# Plot
p <- fln_long |> 
    filter(Parameter_FLN %in% c("LV", "SV", "SN", "LN")) |>
