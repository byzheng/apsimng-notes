...
|-----------|-------|-----------------|------------------------------------------------------|
| CAMP | [IVrnExpression](/docs/Models/PMF/Phenology/CAMP/IVrn1Expression.qmd) | Link | Provides vernalisation gene expression signals (Vrn1, Vrn2, Vrn3, BaseVrn, MaxVrn) |
| Clock | [IClock](/docs/Models/IClock.qmd) | Link | Provides the current simulation date and time |
