...
| 4 | FloralInitiation | 31 | Linear interpolation | Floral initiation |
| 5 | GreenBud | 51 | Linear interpolation | Green bud visible |
| 6 | StartFlowering | 60 | Linear interpolation | Start of flowering |
| 9 | EndFlowering | 69 | Linear interpolation | End of flowering |
| 10 | EndPodDevelopment | 79 | Linear interpolation | End of pod development |
...
| 4.0 | FloralInitiation | 31 | Floral initiation |
| 5.0 | GreenBud | 51 | Green bud visible |
| 6.0 | StartFlowering | 60 | First flowers open |
| 9.0 | EndFlowering | 69 | End of flowering |
| 10.0 | EndPodDevelopment | 79 | End of pod development |
...
stage_data <- data.frame(
    APSIM_Stage = c(3.0, 4.0, 5.0, 6.0, 9.0, 10.0, 11.0, 12.0),
    BBCH_Stage = c(10, 31, 51, 60, 69, 79, 87, 90),
    Description = c("Emergence", "Floral initiation", "Green bud", 
                   "Start flowering", "End flowering", "End pod development",
