...
The **SpikeletsDifferentiating** phase in [Wheat](/docs/Crops/Wheat) represents the developmental period from **DoubleRidge** to **MaximumSpikeletPrimordia**. It is influenced by vernalisation expression after double ridge.
