...
We demonstrate daily thermal time using [example simulations](/docs/Plants/Wheat/Examples/wheat_example1.qmd) for wheat. These simulations illustrate how daily thermal time is calculated based on daily minimum and maximum temperatures, which are key drivers of crop development.
