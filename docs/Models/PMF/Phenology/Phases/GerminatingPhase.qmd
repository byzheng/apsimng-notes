...
| WaterBalance | [ISoilWater](/docs/Models/Interfaces/ISoilWater.qmd) | Link, First Available | Supplies current soil water content for each layer. |
...
| Clock | [IClock](/docs/Models/IClock.qmd) | Link, First Available | Provides current simulation date and time information. |
| SoilTemperature | [ISoilTemperature](/docs/Models/Interfaces/ISoilTemperature.qmd) | Link, First Available | Supplies soil temperature at each layer. |
