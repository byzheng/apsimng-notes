...
where $N_{emergence}$ is the number of leaf tips at emergence which is determined by `TipsAtEmergence` property of the connected ILeaf model (e.g. 1 for wheat).
