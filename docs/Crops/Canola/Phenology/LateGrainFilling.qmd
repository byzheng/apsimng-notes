...
The **LateGrainFilling** phase in [Canola](/docs/Crops/Canola) represents the developmental period from **EndPodDevelopment** to **EndGrainFill**. It is influenced by thermal time only.
