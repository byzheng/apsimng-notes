...
The model also accounts for how sensitive the plant is to [day length](/docs/Models/Functions/PhotoperiodFunction.qmd) . When days are short (less than 12 hours), leaf appearance slows down. The photoperiod effect is calculated as:
