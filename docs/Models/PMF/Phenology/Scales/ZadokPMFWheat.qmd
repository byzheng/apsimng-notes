...
|----------------------|-----------------|------------------|------------------------------------------------------|
| [Phenology](/docs/Models/PMF/Phenology/Phenology.qmd) | **First Available** | Developmental driver | Provides current growth phase, stage progression, and fraction completed within phases. |
| [Plant](/docs/Models/PMF/Plant.qmd) | **First Available** | Broader plant context | Supply plant is alive and today's DaysAfterSowing. |
| [TillerNumber](/docs/APSIM.Core/IFunction.qmd) | **Child Connection** | Input function | Total number of tillers the plant will develop. |
| [HaunStage](/docs/APSIM.Core/IFunction.qmd) | **Child Connection** | Input function | The current Haun stage of the plant. |
