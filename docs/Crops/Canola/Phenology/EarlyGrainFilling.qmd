...
The **EarlyGrainFilling** phase in [Canola](/docs/Crops/Canola) represents the developmental period from **StartGrainFilling** to **EndFlowering**. It is influenced by thermal time only.
