...
| Event | Description |
|-------|-------------|
| <a id="Commencing"></a>Commencing | Triggered once at the start of the simulation, giving all models a chance to initialise their state. |
...
| <a id="DoCommence"></a>DoCommence | Occurs each day when the simulation commences. |
